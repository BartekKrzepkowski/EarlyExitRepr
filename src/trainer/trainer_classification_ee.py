...
class TrainerClassification:
    ...
    def run_epoch(self, phase, config):
        ...
        for i, data in enumerate(progress_bar):          
            ...
            if 'train' == phase:
                loss, evaluators = self.ee_wrapper.run_train(x_true, y_true)
                ...
                if tunnel_multi and self.global_step % tunnel_grads_multi == 0 and self.extra_modules['tunnel_grads'] is not None:
